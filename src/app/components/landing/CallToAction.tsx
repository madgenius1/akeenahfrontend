            ...
            <div className="relative z-10 w-full max-w-screen-xl mx-auto px-6 md:px-12 lg:px-8 text-white">
                <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8">
                    ...
                    <div className="flex-shrink-0">
                        <Link
                            href="/contact-us"
                            className="rounded-lg px-6 py-3 inline-block bg-neutral-100 hover:bg-neutral-300 text-neutral-900 font-semibold hover:text-neutral-950 transition-colors duration-200"
                        >
                            Contact Us
                        </Link>
                    </div>
